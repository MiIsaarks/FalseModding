...
namespace ForgottenSkillsTweaks
{
    ...
    {
        private static SkillDef Blightdef;
        private static string OriginalBlightDesc;
        ...
        public static void init()
        {
            ...
            Blightdef = Addressables.LoadAssetAsync<SkillDef>("RoR2/Base/Croco/CrocoPassiveBlight.asset").WaitForCompletion();

            OriginalBlightDesc = Blightdef.skillDescriptionToken;
        ...
        {
            if (config.Blight.Value)
            {
                Blightdef.skillDescriptionToken = "NewBlightDesc";
            }
            else
            {
                Blightdef.skillDescriptionToken = OriginalBlightDesc;
            }
        }
